...
const API_ENDPOINT = '/admin/api/v1/sales-types';

export default function SalesTypesTab({ token }: SalesTypesTabProps) {
  ...
  const handleOpenEditModal = (salesType: SalesType) => {
