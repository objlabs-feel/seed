      ...
      <Paper elevation={0} sx={{ p: 4 }}>
        ...
        <Box sx={{ my: 4 }}>
          <Typography paragraph>
            주식회사 메디딜러(이하 "회사")는 이용자의 개인정보 보호를 매우 중요하게 생각하며, "개인정보 보호법" 및 관련 법령을 준수하고 있습니다. 이 개인정보 처리방침(이하 "방침")은 회사가 운영하는 중고의료기기 경매 플랫폼의 서비스를 이용하는 모든 이용자의 개인정보 수집, 이용, 보관, 처리 및 보호에 관한 사항을 상세히 설명하며, 이용자에게 투명한 정보 제공을 위해 작성되었습니다.
          </Typography>
